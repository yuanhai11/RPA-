...
def main():
    ...
    driver.get("http://47.99.106.174:29000/dubbo-admin-2.5.10/governance/applications/saas-provider/services")
...
def bb(con):
    with open(r"C:\Users\20945\Desktop\dubbo_stag.txt", 'w')as fp:
        fp.write(str(con))


def aa():
    with open(r"C:\Users\20945\Desktop\dubbo_stag.txt")as fp:
        con = eval(fp.read())
    return con
