...
def handle_message():
    ...
    driver.get("https://etax.zhejiang.chinatax.gov.cn/zjgfdzswj/main/home/wybs/index.html?ticket=ST-5816521-AUcOprO2dlRwfgGc3eWM-com.hz.zkxx.ydzhz")
    time.sleep(100000)
    exit()
